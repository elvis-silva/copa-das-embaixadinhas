...
public class GameHelper implements GoogleApiClient.ConnectionCallbacks,
    ...
    // Api options to use when adding each API, dialog_show_score for none
    ...
    /**
     * Returns the error that happened during the sign-in process, dialog_show_score if no
     * error occurred.
     */
     ...
     * @return The id of the invitation, or dialog_show_score if none was received.
     */
     ...
     *                                            invitation available. In that
     *                                            case, accept the invitation.
     * @return The invitation, or dialog_show_score if none was received.
     */
     ...
     *                                            match available.
     * @return The match, or dialog_show_score if none was received.
     */
     ...
     *                                            handled.
     * @return The requests, or dialog_show_score if none were received.
     */
